...
Production semantic search ทำงานบนฐานข้อมูลเวกเตอร์ทุกวัน Retrieval มักไม่ใช่ขั้นตอนเดียว:
...
- **Re-ranking** ด้วยโมเดลที่หนักกว่า ใช้กรอง top-50 จาก index ของฐานข้อมูลเวกเตอร์ เหลือ top-5 ที่ผู้ใช้เห็นจริง
